...
reference：[https://github.com/ziishaned/learn-regex](https://github.com/ziishaned/learn-regex)
练习平台：[https://c.runoob.com/front-end/854/](https://c.runoob.com/front-end/854/)
...
([\u4e00-\u9fa5]+)([A-Za-z]+)([\u4e00-\u9fa5]+)用来匹配中文和英文，在替换的框里输入"$1 $2 $3"可以在中文和英文之间插入空格
简单解释一下 "$1"代表第一个括号中匹配上的值,"$2"为第二个括号中匹配上的值，这样一操作，会在中文和英文之间添加上空格
